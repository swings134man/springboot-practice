...
public class SwaggerConfig implements WebMvcConfigurer {
    ...
    private static final String SERVICE_NAME = "boot-prac";
    private static final String API_VERSION = "V1";
    private static final String API_DESCRIPTION = "boot-prac API TEST";
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder().title(SERVICE_NAME) // 서비스명
                ...
                .licenseUrl("https://github.com/swings134man/boot-prac")
                .build();
